...
class PrintLayoutTest {
    ...
    void packBlocksGreedilyPacksWholeBlocks() {
        assertEquals(List.of(List.of(0, 1), List.of(2)),
                MarkdownPrintLayout.packBlocks(List.of(10.0, 10.0, 10.0), 25));
        assertEquals(List.of(List.of(0, 1, 2)),
                MarkdownPrintLayout.packBlocks(List.of(10.0, 10.0, 10.0), 100));
    }
    ...
    void packBlocksGivesAnOverTallBlockItsOwnPage() {
        ...
        assertEquals(List.of(List.of(0), List.of(1), List.of(2)),
                MarkdownPrintLayout.packBlocks(List.of(10.0, 30.0, 10.0), 20));
        assertEquals(List.of(List.of(0)),
                MarkdownPrintLayout.packBlocks(List.of(30.0), 20));
    }
