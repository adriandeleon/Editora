...
public class Settings {
     ...
     *  {@code "lmstudio"} for isolated Bionic settings, or {@code "codex"} for the ACP adapter. */
    ...
    public boolean isStructuredPreview() {
    ...
    public boolean isCrontabPreview() {
        return crontabPreview;
    }
