...
public record Completion(String label, String insert, Kind kind, String detail, Snippet snippet, Runnable onAccept) {
    ...
    public static Completion word(String w, String detail) {
        return new Completion(w, w, Kind.WORD, detail, null, null);
    }
    ...
    public static Completion ofSnippet(Snippet s) {
        ...
        return new Completion(s.prefix(), s.prefix(), Kind.SNIPPET, detail, s, null);
    }
    ...
    public static Completion lsp(String label, String insert, String detail, Runnable onAccept) {
        return new Completion(label, insert, Kind.WORD, detail, null, onAccept);
    }
}
