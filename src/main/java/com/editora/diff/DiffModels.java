...
public final class DiffModels {
    ...
    public enum RowType { EQUAL, ADDED, REMOVED, MODIFIED }
     ...
     */
    public record Row(RowType type, String left, int leftLine, String right, int rightLine,
                      int[][] leftWordRanges, int[][] rightWordRanges) {
        ...
        public static Row modified(String left, int leftLine, String right, int rightLine,
                                   int[][] leftWordRanges, int[][] rightWordRanges) {
    ...
    public enum UnifiedType { CONTEXT, ADD, REMOVE }
     ...
     */
    public record DiffModel(List<Row> rows, List<UnifiedRow> unified, int added, int removed,
